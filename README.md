...
5. ### Step 5
   ...
   Load following url to see the mock response from sample mock dataset from installed path
   [https://localhost:3030/mockapi/rootLevelApi](https://localhost:3030/mockapi/rootLevelApi)
